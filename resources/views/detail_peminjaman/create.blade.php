...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Detail Peminjaman</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('detail_peminjaman.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('id_peminjaman') is-invalid @enderror" name="id_peminjaman">
                                        ...
                                        @foreach($peminjamans as $p)
                                            <option value="{{ $p->id_peminjaman }}" {{ old('id_peminjaman') == $p->id_peminjaman ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('id_item_buku') is-invalid @enderror" name="id_item_buku">
                                        ...
                                        @foreach($items as $it)
                                            <option value="{{ $it->id_item_buku }}" {{ old('id_item_buku') == $it->id_item_buku ? 'selected' : '' }}>
