                        ...
                        <div class="card-body">
                            <form action="{{ route('anggota.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('kata_sandi') is-invalid @enderror" name="kata_sandi" placeholder="Masukkan Kata Sandi">
                                    @error('kata_sandi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nomor_telepon" value="{{ old('nomor_telepon') }}" placeholder="Masukkan Nomor Telepon">
                                </div>

                                <div class="form-group">
                                    <label for="alamat">Alamat</label>
                                    <textarea class="form-control" name="alamat" placeholder="Masukkan Alamat">{{ old('alamat') }}</textarea>
                                </div>
