			...
			<form action="{{ url('register') }}" method="POST" novalidate>
				...
				<div class="mb-3">
					...
					<div class="input-field">
						<div class="input-wrap d-flex align-items-center">
							...
							<input type="text" name="name" class="form-control @if($errors->has('name')) is-invalid @endif" placeholder="Ricky Tamvan" value="{{ old('name') }}" />
						</div>
					</div>
				...
				<div class="mb-3">
					...
					<div class="input-field">
						<div class="input-wrap d-flex align-items-center">
							...
							<input type="email" name="email" class="form-control @if($errors->has('email')) is-invalid @endif" placeholder="you@example.com" value="{{ old('email') }}" />
						</div>
					</div>
				...
				<div class="form-group mb-3">
					<label class="form-check-label">
						<input class="form-check-input me-2" type="checkbox" name="agree" value="1" {{ old('agree') ? 'checked' : '' }} /> I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>
					</label>
